...
public class VerClubsInscritos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
          ...
          Cookie cookies[] = request.getCookies();         
            if(cookies == null || Integer.parseInt(cookies[0].getValue()) == -1){
                ...
                id = Integer.parseInt(cookies[0].getValue());
            }
            
        consultaBD consulta = new consultaBD();
        List <Club> list = consulta.getClubsInscritos(id);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<a style=\"color: rgb(0, 69, 153);\" href=\"/Clubs/DesplegarClubs\">Ver todos los clubs</a>");
            out.println("<a style=\"color: red;\" href=\"/Clubs/CerrarSesion\">Cerrar sesión</a>");
            
            if(list.size() == 0){
                out.println("<h1 class=\"titulo\">No hay clubs inscritos</h1>");
            }else{
                out.println("<h1 class=\"titulo\">Clubs inscritos</h1>");
                 out.println("<br>");
            //====================TABLA===============
             for(Club c:list){
                //out.println("<div>");
             ...
             out.println("<a style=\"color: red;\" href=\"/Clubs/EliminarClub\">Dar de baja Club</a>");
            }
